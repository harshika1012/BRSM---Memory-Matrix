...
single_levelwise_rt <- single_levelwise_rt[!is.nan(single_levelwise_rt)]
multi_levelwise_rt <- colMeans(multi_levelwise_rt, na.rm = TRUE)

plot(single_levelwise_rt,
     type = "b",
     pch = 19,
     col = "blue",
     xlab = "Level",
     ylab = "Mean Response Time (in sec)",
     main = "Single Target Lab - Response Time by Level")
plot(multi_levelwise_rt,
     type = "b",
     pch = 19,
     col = "darkgreen",
     xlab = "Level",
     ylab = "Mean Response Time (in sec)",
     main = "Multi Target Lab - Response Time by Level")

print(sqrt(mean((single_lab_rt - mean(single_lab_rt))^2)))
print(sqrt(mean((multi_lab_rt - mean(multi_lab_rt))^2)))
print(sd(single_lab_rt))
print(sd(multi_lab_rt))